...
void            Banner()
{
    Log("\n%s " ZHLT_VERSIONSTRING " " HACK_VERSIONSTRING
    ...
    Log("\n"
		...
		"Based on Solokiller's VHLT-clean\n"
        "which is based on code modifications by 'Vluzacn' (VHLT v34) and Sean 'Zoner' Cavanaugh (ZHLT 3.4)\n"
        "ZHLT originally being based on Valve's version, modified with permission.\n\n"
